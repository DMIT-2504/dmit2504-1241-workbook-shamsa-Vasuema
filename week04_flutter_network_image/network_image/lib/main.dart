      ...
      body: Center(
        child: Column(
          ...
          children: [
            Container(
              height: 500,
              width: double.infinity, //this will take up the entire width of the screen; cannot be applied to the height
            ...
            ElevatedButton(onPressed: _fetchImage, child: Text('Load Image'))
          ],
        ),
      ),
    );
